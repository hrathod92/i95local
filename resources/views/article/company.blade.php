      ...
      @if ( $items->count() )
        @foreach ( $items AS $article )
          <tr>
            ...
            <td class="type" data-label="Type">{!! $article->getCatStrWithAnchors() !!}</td>
            ...
            <td class="action align-center nowrap"><a class='button small' href="/articles/{{ $article->id }}/edit">edit</a></td>
          </tr>
        @endforeach
      @else
