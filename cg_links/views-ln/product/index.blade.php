<?php
$page['title'] = 'Products';
$page['sideblocks'] = ['product._block_index'];
$page['css'] = 'dashboard';
?>
...
@section( 'content' )
    ...
    <table>
      <thead>
        <tr>
          <th>Product</th>
          <th class="align-center">Tagline</th>
      ...
      <tbody>
        @if ( isset( $items ))
            ...
            <tr>
              <td class="title" data-label="Product">
              ...
              <td class='edit align-center nowrap'>
                <a class='button small' href='/products/{{ $item->id }}/edit'>Edit</a>
              </td>
            </tr>
            @endforeach
        @endif
